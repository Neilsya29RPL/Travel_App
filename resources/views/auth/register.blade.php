...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .error-text{color:#ef4444; font-size:12px; margin-top:10px}
    </style>
</head>
<body>
    <div class="screen">
        ...
        <div class="panel">
            <div class="card">
                ...
                {{-- Error global dihapus; gunakan pesan per-field di bawah input --}}
                ...
                <form class="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="field">
                        <label for="password_confirmation">Konfirmasi Kata Sandi <span style="color:#ef4444">*</span></label>
                ...
                {{-- Pesan error gabungan dihapus; tampilkan per-field --}}
            </div>
        </div>
    </div>
</body>
