...
<header>
    ...
    <nav>
        ...
        @auth
            <a href="{{ route('preferences.index') }}" class="{{ request()->routeIs('preferences.*') ? 'active' : '' }}">Preferensi Destinasi</a>
            <a href="{{ route('recommendations.accommodations', ['recommendation_id' => 58]) }}" class="{{ request()->routeIs('recommendations.accommodations') ? 'active' : '' }}">Preferensi Akomodasi</a>
            <a href="{{ route('budget.index') }}" class="{{ request()->routeIs('budget.*') ? 'active' : '' }}">Anggaran</a>
